...
import { IllusionistHTMLManager } from "./htmlmanager";
...
export class WidgetRenderer extends Widget implements IRenderMime.IRenderer {
  constructor(options: IRenderMime.IRendererOptions, manager: IllusionistHTMLManager) {
    super();
  ...
  private _manager: IllusionistHTMLManager;
}
